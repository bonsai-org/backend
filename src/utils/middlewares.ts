...
export function getMissingBodyFields(req: Request, requiredFields: string[]): string[] {
...
export function getDirtyFields(req: Request, fields: string[]): string[] {
    ...
    for (let field of fields) {
        if (typeof (req.body[field]) === 'string' && (isDirtyString(req.body[field]) || containsHTMLTags(req.body[field]))) {
